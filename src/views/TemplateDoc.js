    ...
    <>
      <Row>
        ...
        <Col xs={12} style={{ marginTop: "8%" }}>
          <Row>
            <Col xs={12} md={2}>
              <div style={{ position: "fixed", top: 100, left: 50 }}>
              ...
              SignatureModal === false && (
                <div
                  ...
                  style={{
                    ...
                    backgroundColor: "rgb(98 188 221 / 28%)", // Light grey with opacity
                    position: "fixed",
                    zIndex: 9999,
              ...
              SignatureModal === false && (
                <div
                  ...
                  style={{
                    ...
                    // margin:0,
                    height: "60px",
                    backgroundColor: "#ffff7f", // Light grey with opacity
                    position: "fixed",
                    zIndex: 9999,
                    pointerEvents: "none", // Make sure the box doesn't interfere with mouse events
                  }}
                                  ...
                                  <Button
                                    ...
                                    onClick={() => {
                                      if (
                                        ...
                                        let bgColor =
                                          savedCanvasData[index]
                                            .backgroundColor;
                                        let darkenedBgColor =
                                          lightenColor(bgColor);
                                        const newSavedCanvasData = [
                                          ...savedCanvasData,
                                        ];
                                        newSavedCanvasData[
                                        ...
                                        newSavedCanvasData[
                                          index
                                        ].backgroundColor = darkenedBgColor;
                                        setSavedCanvasData(newSavedCanvasData);
                        ...
                        >
                          ...
                          <Maximize size={15}/>
                              ...
                              position.url === undefined ? (
                                <div
                                  onClick={() =>
                                    handleTextClick(index, "signer_initials")
                                  }
                                  style={{
                                    backgroundColor: `${position.backgroundColor}`,
                                    width: `${position.width}px`,
                      ...
                      return (
                        ...
                        >
                          <div
                            ...
                            onClick={() =>
                              handleTextClick(index, "signer_radio")
                            }
                          >
                            <div
                              style={{
                                  ...
                                  <Button
                                    ...
                                    onClick={() => {
                                      if (position.direction === "row") {
                                        ...
                                        newSavedCanvasData[index].direction =
                                          "column";
                                        setSavedCanvasData(newSavedCanvasData);
                                      } else {
                                        const newSavedCanvasData = [
                      ...
                      return (
                        ...
                        >
                          <div
                            ...
                            onClick={() =>
                              handleTextClick(index, "signer_dropdown")
                            }
                          >
                            <div
                              style={{
