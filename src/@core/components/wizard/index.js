      ...
      return (
        <Fragment key={step.id}>
          ...
          <div
            ...
            data-target={`#${step.id}`}
          >
            <button type='button' className='step-trigger' style={{display:'flex',flexDirection:'column'}}>
      ...
      style={{display:'flex',
       ...
       className={classnames('bs-stepper-header',
        { [headerClassName]: headerClassName })}>
          {renderHeader()}</div>
      <div
       className={classnames('bs-stepper-content', { [contentWrapperClassName]: contentWrapperClassName })}
       >
        {renderContent()}
      </div>
    </div>
