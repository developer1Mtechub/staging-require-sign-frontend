  ...
  async ({ user_id, token }, { rejectWithValue }) => {
    ...
    try {
      ...
      if (response?.result?.length > 0) {
        ...
        // const logo = response?.companyProfile?.company_logo || logoRemoveBg;
...
// let free_plan,days_remaining,subscription_plan;

// const currentDate = new Date();
// if (user_current_subscription?.free_trial === "true") {
//   const freeTrialEndDate = new Date(user_current_subscription.free_trail_end_date);
...
//       // Check if subscription_start_date or subscription_end_date are null
//       if (!user_current_subscription.subscription_start_date || !user_current_subscription.subscription_end_date) {
//           user_current_subscription.subscription_start_date = null;
//           user_current_subscription.subscription_end_date = null;
//           user_current_subscription.status = "expired";
//           console.log("Subscription is expired, start and end dates set to null.");
//         subscription_plan =false

//       } else {
//         subscription_plan =true
//         const subscriptionEndDate = new Date(user_current_subscription.subscription_end_date);

//       const remainingDays = Math.ceil((subscriptionEndDate - currentDate) / (1000 * 60 * 60 * 24));
//       days_remaining=remainingDays
//           console.log("Subscription start and end dates are already set.");
//       }
//   } else {
//     subscription_plan =false
//     free_plan = true;

//       // Free trial has not expired, calculate remaining days
//       const remainingDays = Math.ceil((freeTrialEndDate - currentDate) / (1000 * 60 * 60 * 24));
//       console.log(`Free trial is active. Days remaining: ${remainingDays}`);
//     days_remaining=remainingDays

//   }
// } else {
//   console.log("No free trial.");
// }
        ...
        return {
          ...
          logo: response?.companyProfile?.company_logo || logoRemoveBg,
